...
function consultar(){
    ...
    $.ajax({
          type: "POST",
          url: "pages/auditoria_pre_nomina_online.php",
...
function ver_fichadas(trabajador, nombre){
    $.ajax({
          type: "POST",
          url: "pages/buscar_fichadas_reales.php?trabajador="+trabajador+"&nombre="+nombre,
          data: $("#formulario").serialize(),
          dataType: "html",
          beforeSend: function(){
                //imagen de carga
...
<body>
<header id="titulo">      
      <IMG SRC="pages/images/header.jpg" width="100%" height="200px" >
</header>
    <div id="wrapper">

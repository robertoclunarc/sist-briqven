...
<!--                <th width="10%">Fecha</th> -->
        ...
        <tbody>';                            
		    ...
		    $resultado4=mostrar_esperanza($row['salida_esperada2']);
                    ...
                    $inpt .='<td><input type="hidden" id="entrada_esperada2" name="entrada_esperada2" value="'.$row['entrada_esperada2'].'"></input><span class="'.$resultado3[0].'">'.$resultado3[1].'</span></td>';
                    $inpt .='<td><input type="hidden" id="salida_esperada2"  name="salida_esperada2"  value="'.$row['salida_esperada2'].'"></input><span class="'.$resultado4[0].'">'.$resultado4[1].'</span></td>';
...
//                    $inpt .='<td><input type="hidden" id="salida_esperada2"  name="salida_esperada2"  value="'.$row['salida_esperada2'].'"></input>'.$row[].'</td>';
                    $inpt .='</tr>';
                    $inpt2 .='<tr>';
                    ...
                    $inpt2 .='<td><input type="hidden" id="salida_real2" name="salida_real2" value="'.$row['salida_real2'].'"></input>'.$row['entrada_real2'].'</td>';
                    $inpt2 .='</tr>';                        
                    $inpt3 .='<tr>';
          ...
          $inpt4 .='<td><input type="hidden" id="salida_st_interno"  name="salida_st_interno"  value="'.$row['salida_te'].'"></input>'.$row['salida_te'].'</td>';
		   ...
		   if ($row['cambio_permanencia']=='S'){
                       if ($encabezado_cp==0){ 
                          ...
                          $inpt6 .='<td><input type="hidden" id="entrada_st_interno" name="entrada_cp_interno" value="'.$row['entrada_te'].'"></input>'.$row['entrada_te'].'</td>';
                          $inpt6 .='<td><input type="hidden" id="salida_st_interno"  name="salida_cp_interno"  value="'.$row['salida_te'].'"></input>'.$row['salida_te'].'</td>';
		              ...
		              //  $c=$c."-".$numReg."<br>dlt=".$row['dlt'];
	 	              if ($row['dlt']=='S'){
		                  $encabezado_dlt=0;
                      if ($encabezado_dlt==0){ 
                          $inpt7 = '<b>DLT</b><br> <table width="90%" class="table table-striped table-bordered table-hover" id="dataTables-example">';
                          $inpt7 = $inpt7.'<thead>
                                    <tr>
                                        <th width="10%">Entrada DLT</th>                 
                                        <th width="10%">Salida DLT</th>
                          ...
                          $inpt7 .='<td><input type="hidden" id="entrada_dlt_interno" name="entrada_dlt_interno" value="'.$row['entrada_real1'].'"></input>'.$row['entrada_real1'].'</td>';
                          $inpt7 .='<td><input type="hidden" id="salida_dlt_interno"  name="salida_dlt_interno"  value="'.$row['salida_real1'].'"></input>'.$row['salida_real1'].'</td>';
                          $inpt7 .='<input type="hidden" id="motivo2"  name="motivo2"  value="'.$row['motivo_dlt'].'"></input>';
                          if ($row['autorizado_dlt']!=''){
                                $inpt7 .='<td>*</td>';
                                $inpt7 .='<input type="hidden" id="autorizado"  name="autorizado"  value="'.$row['autorizado_dlt'].'"></input>';
                          }else{
                                $inpt7.='<td></td>';
                                $inpt7 .='<input type="hidden" id="autorizado"  name="autorizado"  value=""></input>';
			                    }
                          $inpt7.='</tr>';
                 }
            }
           }else{
                $inpt7 .='<input type="hidden" id="motivo2"  name="motivo2"  value=""></input>';
                $inpt7 .='<input type="hidden" id="autorizado"  name="autorizado"  value=""></input>';
            }

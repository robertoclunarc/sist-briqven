    ...
    <div id="wrapper">
         ...
         <nav class="navbar navbar-<?php echo $_SESSION['modeBlack_const']; ?> navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">                
                <a class="navbar-brand" href="index.php">Control Asistencia - N&oacute;mina</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table" border ="0">
                                <tr> 
                                        <th>Desde</th>  
                                        <th><input type="date" class="form-control" name="txtfinicio" value="<?php echo date("Y-m-d",time()-3600); ?>" id="txtfinicio" ></th>        
                                        <th>Hasta</th>
                                        <th><input type="date" class="form-control" name="txtffin" value="<?php echo date("Y-m-d",time()-3600); ?>" id="txtffin" ></th>
                                        <th>Trabajador</th>  
					...
					<th><INPUT id="cmdGuardar" type="button" value="Consultar"  class="btn btn-primary" onclick="listar_horas_extras();"/></th>

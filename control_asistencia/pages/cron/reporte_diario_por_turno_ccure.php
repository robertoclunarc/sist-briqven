...
if ($turno==1){
	...
	$sqlCtrlAcceso.= "'".$hoy." 13:15:00' AND '".$hoy." 16:00:00' ";
        ...
        $complemento='and CAST(fecha as datetime) BETWEEN \''.$hoy.'\' AND \''.$hoy.'\'
        and hora > \'05:15:00\' and hora  <=\'08:50:00\'';
        $sqlCtrlAcceso.= "'".$hoy." 05:15:00' AND '".$hoy." 08:50:00' ";
}
...
$cuerpo=$inpt;
$resp1=ENVIAR_CORREO($cuerpo,$asunto,"","", "","matoso@briqven.com.ve","matvxl@briqven.com.ve");

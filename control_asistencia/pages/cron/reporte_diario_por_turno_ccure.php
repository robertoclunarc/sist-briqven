...
if ($turno==1){
	...
	$subtitulo= ', <br>que ingresaron entre las 21:15:00 '.date("Y-m-d",strtotime($hoy."- 1 days")).' y 23:59:59 ';
}else if ($turno==2){
	$complemento='and CAST(fecha as datetime) BETWEEN \''.$hoy.'\' AND \''.$hoy.'\'
	and hora > \'05:15:00\' and hora  <=\'08:00:00\'';
	$sqlCtrlAcceso.= "'".$hoy." 05:15:00' AND '".$hoy." 08:00:00' ";
	$subtitulo= ', <br>que ingresaron entre las 05:15:00 y 08:00:00 ';
}else if ($turno==3){
	$complemento='and CAST(fecha as datetime) BETWEEN \''.$hoy.'\' AND \''.$hoy.'\'
	and hora > \'13:15:00\' and hora  <=\'16:00:00\'';
	$sqlCtrlAcceso.= "'".$hoy." 13:15:00' AND '".$hoy." 16:00:00' ";
	$subtitulo= ', <br>que ingresaron entre las 13:15:00 y 16:00:00 ';
}else if ($turno==4){
        $complemento='and CAST(fecha as datetime) BETWEEN \''.$hoy.'\' AND \''.$hoy.'\'
        and hora > \'05:15:00\' and hora  <=\'08:45:00\'';
        $sqlCtrlAcceso.= "'".$hoy." 05:15:00' AND '".$hoy." 08:45:00' ";
        $subtitulo= ', <br>que ingresaron entre las 05:15:00 y 08:45:00 ';
}else if ($turno==5){
        $complemento='and CAST(fecha as datetime) BETWEEN \''.$hoy.'\' AND \''.$hoy.'\'
        and hora > \'13:15:00\' and hora  <=\'17:15:00\'';
        $sqlCtrlAcceso.= "'".$hoy." 13:15:00' AND '".$hoy." 17:15:00' ";
        $subtitulo= ', <br>que ingresaron entre las 13:15:00 y 17:15:00 ';
}  
       ...
       $cn=Conectarse_sitt();
        ...
        if($contar == 0){
             ...
             while($row = $stmt1->fetch(PDO::FETCH_ASSOC, PDO::FETCH_ORI_NEXT)){
             	if ($turno==4) $turno2 =2; else $turno2 =$turno;
			   	if ($PrimeraVez=='Si'){
					...
					<td colspan="5" align="center">
					    <h2><b>Reporte de entrada del personal del turno: '.$turno2.', del '.$row['dia_semana']." ".date("d-m-Y", strtotime($hoy)).$subtitulo.' </b></h2>
					</td>
				    </tr>
					</thead>
						</table>
...
$asunto="Reporte General de asistencia del: ".date("d-m-Y", strtotime($hoy)).", Turno:".$turno2;
$cuerpo=$inpt;
...
if ($turno<4){
	...
	// CORREO ENVIADO A
	// HECTOR FIGUERA Y CIPRIANO
	ENVIAR_CORREO($cuerpo,$asunto,"", "","","matfih@briqven.com.ve","brilci@briqven.com.ve");

	// YENNY MAY
	ENVIAR_CORREO($cuerpo,$asunto,"","","","matmye@briqven.com.ve","yen.may08@gmail.com");

	// MARIA BRITO GMAIL
	ENVIAR_CORREO($cuerpo,$asunto,"", "","","tecnologiaeinformacionbriqven@gmail.com","");
}

if ($turno==4){
	//CORREO ENVIADO A LOS CORREOS GMAIL DE MARY MONTAÑO Y SUELVIN
	ENVIAR_CORREO($cuerpo,$asunto,"", "","","matmma@briqven.com.ve","matsos@briqven.com.ve");

    // MARIA CAROLINA
    ENVIAR_CORREO('<p>&nbsp;</p>Favor Revisar Archivo Adjunto.',$asunto,$dpf,"","","tecnologiaeinformacionbriqven@gmail.com","matzem@briqven.com.ve");
}
...
if ($turno==5){
   ...
   // MARY MONTAÑO Y MARIA CAROLINA, ESTE LLEGA EN FORMATO PDF
   ENVIAR_CORREO('<p>&nbsp;</p>Favor Revisar Archivo Adjunto.',$asunto,$dpf,"","","matmma@briqven.com.ve","tecnologiaeinformacionbriqven@gmail.com");

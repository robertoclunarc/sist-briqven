  ...
  if ($("#hddcontador").val()=="0")
  {
    ...
    $.ajax({
         ...
         //alert(data); // Mostrar la respuestas del script PHP.
	         if (data!="ERROR")
	          {
	            alert("La Constacia Fue Emitida Correctamente!");
              abrir_constacias(data);
	            location.reload();
	          }
	         else
	         {
...
//(*--------------------------------------------*)
function abrir_constacias(fecha)
{
 var wi = 800;
    var he = 400;
    var posicion_x; 
    ...
    var ventana = window.open("formato_constancias1.php?fec="+fecha, "Constacia", "width="+wi+",height="+he+",menubar=NO,toolbar=NO,directories=NO,scrollbars=YES,resizable=YES,left="+posicion_x+",top="+posicion_y+"");          
...
function AgregarFilaInfo()
{
  if ($("#txtnombres").val()!='' && !valida_repetido($("#hddcedula").val())){
    ...
    var tabla="<tr>";
    tabla=tabla+"<td width='20%'>"+valor_col1+ctrl_col1+"<td>";
...
<table width="90%">
    ...
    <tr> 
       <td><div class="form-group input-group"><INPUT type="text" id="txtcedula" onkeypress="return validar(event)" maxlength="10" name="txtcedula" value=""
         width="100%"  class="form-control"/> <span class="input-group-btn"><button class="btn btn-default" onclick="BuscarInfo($('#txtcedula').val());" type="button"><i class="fa fa-search-plus"></i>
                        </button>
                    </span>        
           </div></td>
        <td> &nbsp;</td>
       <td><div class="form-group input-group">
                  <input type="text" id="txtnombres" maxlength="100" placeholder="" readonly="" name="txtnombres"  class="form-control">
                    <span class="input-group-btn">
                        <button class="btn btn-default" onclick="AgregarFilaInfo();" type="button"><i class="fa fa-plus-circle"></i>
                        </button>
                    </span>        
           </div></td>
    </tr>
...
<table class="" width="90%" id="tblGuardar" align="center">  
  <tr>
    <td width="30%">&nbsp;</td>
    <td width="40%" align="center"><INPUT id="cmdGuardar" type="button" value="Emitir Constancia"  class="btn btn-success" onclick="GuardarRegistro();"/></td>
    <td width="30%">&nbsp;</td>
  </tr>
</table>
<p>&nbsp;</p>

...
*/
	...
	$("#chkcambioturno").change(function(){
			...
			limpiar_esperanza();
			limpiar_hora();
//	 		CargarCombo($("#cboesperanza_cambiada"),"cargar_combo_array.php?combo=");
/*		    var sel = document.getElementById("cboesperanza_cambiada");
		    while (sel.length > 0) {
		          sel.remove(sel.selectedIndex);
		    }
						...
						<td colspan="2">
							...
							<tr>
							    <td><label>Grupo: </label></td>
                                                            <td><select id="cbogrupo" class="form-control"> </select></td>
                                                         </tr>
                                                    </table>         
                                                </td>
                                            </tr>      
							    ...
							    <td align="right"><label>Comisi&oacute;n de Servicio: &nbsp;&nbsp;</label></td>
                        	                            ...
                        	                            <td><input type="checkbox" class="custom-control-input" id="chksobretiempo"> </td>
						        </tr> 
					             </table>
						</td>
					    </tr>

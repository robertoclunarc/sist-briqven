...
if (isset($_SESSION['user_session_const'])){
  ...
  if($numReg>0){
    ...
    while ($fila=ejecutar_fetch_array($result)) 
    {
        $optCCosto.= "<option value='". $fila['descripcion_unidad']."'>" ;
...
function consultar(){
    ...
    $.ajax({
          type: "POST",
          url: "consultar_stdlt_nomina_online.php",
...
function Imprimirplanilla()
{
    ...
    var ventana = window.open("planilla_mensual_stdlt.php?query="+query, "STDLT", "width="+wi+",height="+he+",menubar=NO,toolbar=NO,directories=NO,scrollbars=YES,resizable=YES,left="+posicion_x+",top="+posicion_y+"");          
}
...
function exportar_excel_listado(){
    ...
    var namexls="Listado_de_STDLT_"+nombre_archivo+"desde"+desde+"al"+hasta+".xls";
...
//(*--------------------------------------------*)
function exportar_excel_cuadro(){
    var desde=$("#txtfinicio").val();
    var hasta=$("#txtffin").val();
    if ($("#cbotrabajador").val()!="NULL")
      ...
      var nombre_archivo="";
    var namexls="Cuadro_Acumulado_de_STDLT_"+nombre_archivo+"_desde"+desde+"al"+hasta+".xls";
    var inpt = '<table><thead><tr><th>'+'Horas extras y dia libre trabajados. '+'</th><th>'+'Fecha: '+desde+' al '+hasta+'</th></tr></thead></table>';
...
function editCell(trabajador, fecha, ndiv){  
    ...
    //var boton = '<button type="button" btn-xs" data-toggle="modal" onclick="ver_fichadas('+param+')" data-target="#exampleModalCenter">' + $('#hddDatosCell').val() + '</button>'
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">ST y DLT Aprobados (uso exclusivo de Nomina)</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <form role="form" id="formulario" method='post'> 
                                      ...
                                      <table width="90%">    
                                        ...
                                        <tr> 
                                          ...
                                          <td><a onclick="exportar_excel_listado()" title="Exportar Excel" href='#'><img src='images/expor_excel1.png' WIDTH='30' HEIGHT='30'></a> </td>
                                        </tr>    
                                      </table>
                                      </div>
                                      <p>&nbsp;</p>

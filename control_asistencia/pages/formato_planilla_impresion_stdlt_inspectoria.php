...
$qry2 = iconv("UTF-8", "ASCII//TRANSLIT", $qry);
//print $qry2;
...
if($contar == 0){
  ...
  $inpt = '<table width="100%">
              <tr>
                <td>
                  <font face="nunito,Arial,verdana" SIZE=2><br>
                      <b>Sres.</b><br>
                      ...
                      <br>
                      <b>Presente.</b><br>
                      <b>Asunto:</b> Entrega del reporte de hora extra generados por los trabajadores.
  ...
  $tabla     = '<table border="1"><tr>
                ...
                <td width="15%" style="text-align:center">Horas Extra</td>              
            </tr>';
  ...
  while($row = $stmt1->fetch(PDO::FETCH_ASSOC, PDO::FETCH_ORI_NEXT)){
        ...
        /*if (str_replace("Ñ","&ntilde;",$row['nombres'])){
          print '<br>'.str_replace("Ñ","&ntilde;",$row['nombres']);
        }*/
        $nombre_trabajador= iconv("ISO-8859-1", "ASCII//TRANSLIT", $row['nombres']);        // ESTOS DOS FUNCIONAN 1
        $nombre_trabajador= iconv("UTF-8", "ISO-8859-1//TRANSLIT", $nombre_trabajador);     // ESTOS DOS FUNCIONAN 2
        //$nombre_trabajador= iconv("UTF-8", "ISO-8859-1//TRANSLIT", $row['nombres']);
        $nombre_trabajador3= iconv("UTF-8", "ASCII//TRANSLIT", $row['nombres']);
        //$nombre_trabajador=str_replace("Ñ","&ntilde;",$row['nombres']);
        //$nombre_trabajador= iconv("ISO-8859-1", "ASCII//TRANSLIT", $row['nombres']);
        $nombre_trabajador2= iconv("UTF-8", "ISO-8859-1//TRANSLIT", $nombre_trabajador);
        $nombre_trabajador4= iconv("ASCII", "UTF-8//TRANSLIT", $row['nombres']);

        $tabla .='<td width="45%">&nbsp;&nbsp;'.ucwords(strtolower($nombre_trabajador)).'</td>';
        //$tabla .='<td width="45%">&nbsp;&nbsp;'.mb_detect_encoding($row['nombres']).'</td>';
        //$tabla .='<td width="45%">&nbsp;&nbsp;'.$nombre_trabajador4.'</td>';
  ...
  //print "Cantidad de Registro:".$contar;
  $tabla .='<tr>

...
<head>
    ...
    <title>Autorizar ST y DLT</title>
...
function consultar(){
  if ($('#cbotipooperacion').val()=='NULL'){
    ...
    if ($('#cbotipooperacion').val()=='1'){
       var url = "autorizar_te_online.php";
    }
    if ($('#cbotipooperacion').val()=='2'){
       var url = "autorizar_dlt_online.php";
    }   
  }  
  $.ajax({
        type: "POST",
...
function ver_fichadas(trabajador, fecha, button){
    ...
    $.ajax({
          type: "POST",
          url: "hoja_de_tiempo_x_trabajador_a.php?trabajador="+trabajador+"&fecha="+fecha+"&btn="+button,
          data: $("#formulario").serialize(),
          async: false,
          dataType: "html",
          beforeSend: function(){
...
$.ajax({
          type: "POST",
          url: "autorizar_stdlt_db.php?SP="+SP,
          data: $("#formulario").serialize(),
          dataType: "html",
          beforeSend: function(){
                //imagen de carga
          ...
          success: function(data){                                                    
            ...
            if (data==1){
                  setTimeout(() => { 
                    $("#capa1").append('<div class="alert alert-success">Operacion Exitosa, se envio un correo electronico con el resultado de la misma </div>'); 
                  }, 1000);
                  consultar();
                }else{
                    //$("#mensaje").remove();
                    $("#capa1").append('<div class="alert alert-danger">'+data+'</div>');
                }
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">Autorizar ST y DLT</h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                      ...
                                      <table width="90%">    
                                        <tr>
                                          ...
                                          <td> &nbsp;</td>
                                           ...
                                           <td> &nbsp;</td>
                                           <td><label>Tipo de Operacion:</label></td>
                                           <td> &nbsp;</td>
                                         ...
                                         <tr> 
                                          ...
                                          <td><select name="cbostatus" id="cbostatus" data-width="80%" data-size="5"class="selectpicker" data-live-search="true">
                                                 ...
                                                 <option value="2">Sin Autorizar</option>
                                               </select>   

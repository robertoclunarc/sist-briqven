...
<header id="titulo">      
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Reporte de Asistencia (CCURE)</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<table width="90%">    
    <tr>
      ...
      <td width="1%"> &nbsp;</td>
       ...
       <td width="1%"> &nbsp;</td>
       <td width="6%"><label>Direcci&oacute;n:</label></td>
       <td width="5%"> &nbsp;</td>
       <td width="5%"> &nbsp;</td>
       <td width="5%"> &nbsp;</td>
       <td width="5%"> &nbsp;</td>
      ...
      <td> &nbsp;</td>
       ...
       <td  align="center">
        ...
        <td  align="center">
          ...
          <INPUT id="cmdPorcentaje" type="button" value="%" title="Porcentaje de entrada y salida" class="btn btn-info" onclick="porcentajes();"/>

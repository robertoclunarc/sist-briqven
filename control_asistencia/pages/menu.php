...
switch ($_SESSION['nivel_const']) {
    ...
    case ($_SESSION['nivel_const']==1 ):
        $barra.='<div class="navbar-'.$_SESSION['modeBlack_const'].' sidebar" role="navigation">
                ...
                if ((permiso_usuario($linkMenu, 'REALIZAR', 'cambio_turno', $_SESSION['user_session_const'])) || (permiso_usuario($linkMenu, 'CONSULTAR', 'cambio_turno', $_SESSION['user_session_const'])))
                {
                                $barra.='<li>
                ...
                if (permiso_usuario($linkMenu, 'AUTORIZAR', 'autorizar_ct.php', $_SESSION['user_session_const']))
                {
                                $barra.='                                                
                        <li>

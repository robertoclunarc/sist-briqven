...
<head>
    ...
    <link href="style_login.css" rel="stylesheet" type="text/css" media="screen">
...
<body>    
	...
	<div class="login-form">
       <form class="form-signin" method="post" id="login-form">      
        <h2 class="sub-head-w3-agileits">Sistema Control de Asistencia</h2><hr />        
        <div id="error">
        ...
        <div class="form-group">        
            <div class="checkbox">
                <label>
                    <input data-toggle="toggle" type="checkbox" id="chkModeBlack" name="chkModeBlack" value='inverse'>
                    Modo Oscuro
                </label>
            </div>
        </div>      

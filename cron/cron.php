...
/*----------------------------------------------------------------------------------------------*/
function cambio_cuadrilla( $cn_sitt, $cn_asistencia_laboral){
try{
    ...
    $rslt="Finalizado Con Exito! el cambio de cuadrilla de: ".$cantidad_update." registros. ";
...
guardar_log($msj1, false);
$msj1=cambio_cuadrilla($cn_sitt,$cn_asistencia_laboral);
$msj1 = "Resultado: ".$msj1;
guardar_log($msj1, true);

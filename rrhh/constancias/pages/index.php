...
if (isset($_SESSION['user_session_conslab']) && isset($_SESSION['nivel_conslab'])){
    ...
    $listado="SELECT * FROM tbl_solicitudes ORDER BY fecha DESC";
...
<head>
    ...
    <title>Constancias Solicitadas</title>
    ...
    <div id="wrapper">
         ...
         <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">                
                <a class="navbar-brand" href="index.html">Constancias</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Constancias Solicitadas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->

...
/*
  ...
  Puede convertir un número entre una y ciento veintis&eacute;is cifras como máximo.
 
  Ejemplos de uso:
    CifrasEnLetras::convertirEurosEnLetras(22.34) --> "veintidós euros con treinta y cuatro c&eacute;ntimos"
...
class CifrasEnLetras {
  ...
  public static $listaUnidades = array( // Letras de los números entre el 0 y el 29
    ...
    "diez", "once", "doce", "trece", "catorce", "quince", "diecis&eacute;is", "diecisiete", "dieciocho", "diecinueve",
    "veinte", "veinti&uacute;n", "veintid&oacute;s", "veintitr&eacute;s", "veinticuatro", "veinticinco", "veintis&eacute;is", "veintisiete", "veintiocho", "veintinueve"
  );
  ...
  public static $listaOrdenesMillonSingular = array ( // Letras en singular de los ordenes de millon
    "", "mill&oacute;n", "bill&oacute;n", "trill&oacute;n", "cuatrill&oacute;n", "quintill&oacute;n",
    "sextill&oacute;n", "septill&oacute;n", "octill&oacute;n", "nonill&oacute;n", "decill&oacute;n",
    "undecill&oacute;n", "duodecill&oacute;n", "tridecill&oacute;n", "cuatridecill&oacute;n", "quidecill&oacute;n",
    "sexdecill&oacute;n", "septidecill&oacute;n", "octodecill&oacute;n", "nonidecill&oacute;n", "vigill&oacute;n"
  );
  ...
  // ORDINALES (Wikipedia: "Nombres de los n&uacute;meros en español", "Número ordinal")
 
  public static $listaUnidadesOrdinales = array ( // Letras de los ordinales entre 0º y 19º
    "ning&uacute;n", "primer", "segundo", "tercer", "cuarto", "quinto", "sexto", "s&eacute;ptimo", "octavo", "noveno",
    "d&eacute;cimo", "und&eacute;cimo", "duod&eacute;cimo", "decimotercer", "decimocuarto", "decimoquinto", "decimosexto", "decimos&eacute;ptimo", "decimoctavo", "decimonoveno"
  );
  public static $listaDecenasOrdinales = array ( // Letras de las decenas ordinales
    "", "d&eacute;cimo", "vig&eacute;simo", "trig&eacute;simo", "cuadrag&eacute;simo", "quincuag&eacute;simo", "sexag&eacute;simo", "septuag&eacute;simo", "octog&eacute;simo", "nonag&eacute;simo"
  );
  public static $listaCentenasOrdinales = array ( // Letras de las centenas ordinales
    "", "cent&eacute;simo", "ducent&eacute;simo", "tricent&eacute;simo", "cuadringent&eacute;simo", "quingent&eacute;simo", "sexcent&eacute;simo", "septingent&eacute;simo", "octingent&eacute;simo", "noningent&eacute;simo"
  );
  public static $listaPotenciasDiezOrdinales = array ( // Letras de las potencias de diez ordinales
    "", "d&eacute;cimo", "cent&eacute;simo", "mil&eacute;simo", "diezmil&eacute;simo", "cienmil&eacute;simo", "millon&eacute;simo"
  );
 
  //---------------------------------------------
  // M&eacute;TODOS PRINCIPALES
 
  /*
    Convierte a letras los n&uacute;meros entre 0 y 29
  */
  ...
  */
  ...
  /*
    ...
    - Los caracters no num&eacute;ricos son ignorados.
  ...
  */
  public static function convertirEurosEnLetras($euros, $numeroDecimales=2) {
    return self::convertirNumeroEnLetras($euros, $numeroDecimales,
      "euro", "bolivares", false, "c&eacute;ntimo", "c&eacute;ntimos", false);
  }
...
/*
 echo CifrasEnLetras::convertirEurosEnLetras(111878.10);
 echo '<br>';
 echo CifrasEnLetras::convertirNumeroEnLetras("35,67")
*/ 
?>
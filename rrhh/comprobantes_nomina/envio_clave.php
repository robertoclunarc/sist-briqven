...
if (($("#asunto").val()=="") || ($("#txtTrabajador").val()==""))
	{
...
dir_url = "construir_query_clave.php";
$.ajax({
   type: "POST",
   url: dir_url,
...
<form id="formulario" method='post'>
    ...
    <div class="input-group">
      <input id="asunto" name="asunto" placeholder="Asunto" value="Clave Comprobante de Pago" type="text" class="form-control" style="z-index: 0;" onblur="$(this).val($(this).val().toUpperCase());" >
...
<table width="100%">		
	<tr>
		<td width="10%"><input type="checkbox" checked="" disabled="" name="chkTrabajador" id="chkTrabajador"> </td>

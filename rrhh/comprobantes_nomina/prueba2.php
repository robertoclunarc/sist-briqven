...
///////////TABLA DE DETALLES//////////////////////////////////////////////////////////////////////
  ...
  $query = $query . " decode(rtrim(ltrim(to_char(saldo,'99,999,990.00'))),'0.00','',to_char(saldo,'99,999,990.00')) as SALDO,";
  $query = $query . " decode(rtrim(ltrim(to_char(decode(d.tipo_concepto,1,monto_asig,decode(d.tipo_concepto, 1, MONTO_ASIG, 0)),'99,999,990.00'))),'0.00','',to_char(decode(d.tipo_concepto,1,monto_asig,decode(d.tipo_concepto, 1, monto_asig, 0)),'99,999,990.00')) ASIG, ";
  $query = $query . " decode(rtrim(ltrim(to_char(monto_aporte,'99,999,990.00'))),'0.00','',to_char(monto_aporte,'99,999,990.00')) APORTE, ";
  $query = $query . " decode(rtrim(ltrim(to_char(decode(d.tipo_concepto,3, monto_asig,0),'9,999,990.00'))),'0.00','',to_char(decode(d.tipo_concepto,3, monto_asig,0),'9,999,990.00')) DEDUC_LEY, ";
  $query = $query . " decode(rtrim(ltrim(to_char(decode(d.tipo_concepto,4, monto_asig,0),'99,999,990.00'))),'0.00','',to_char(decode(d.tipo_concepto,4, monto_asig,0),'99,999,990.00')) DEDUC_PERSONAL, ";

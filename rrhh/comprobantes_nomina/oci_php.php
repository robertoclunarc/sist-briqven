...
if ($entro){
 $sqli = "INSERT INTO tbl_historia_medica(fecha_apertura, fk_medico, ha_sufrido_accidentes,ha_padecido_enfermeda,uid_paciente) select fecha_ingreso , 3, 'NO','NO', uid_paciente from tbl_pacientes where ci::numeric not in ".$cedulas;

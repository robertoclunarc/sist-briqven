...
<td> &nbsp;</td>
<td>Motivo:</td>
<td><select onfocus='CargarCombo($("#cboMotivos"),"./cargar_combo_db.php?tabla=motivos&campo1=idmotivo&campo2=descripcion_motivo&selected=0&orderby=idmotivo&firsttext=[Ninguno]")' name="cboMotivos" id="cboMotivos" ></select></td>
<td> &nbsp;</td> 
<td>

...
//alert($("#cbopermiso").val());
	if ((($("#cbotrabajador").val())!='') && ($("#cbotrabajador").val())!='0' && (($("#cbotrabajador").val())!=null)  && (!valida_repetido($("#cbotrabajador").val()))){
	    ...
	    var valor_col11=$("#cboesperanza_cambiada").val();    
            ...
            var valor_col13=$("#cbogrupo").val();
            var valor_col14=$("#cbogrupo option:selected").text();
	    
	    
	    var ctrl_col1="<input name='cedulas[]' type='text' value='" + valor_col1 + "'/>";
	    ...
	    if ($('#chksobretiempo').is(':checked')){
	       var ctrl_col6="<input name='sobretiempo[]' type='hidden' value='S'/>";
               var valor_col6="S";
 	       var ctrl_col6_1="<input name='txthoraini1[]' type='hiden' value='" + valor_col6_1 + "'/>";
	       var ctrl_col6_2="<input name='txthorafin1[]' type='hidden' value='" + valor_col6_2 + "'/>";
	    }else{
...
{
 CargarCombo($("#cbogrupo"),"buscar_datos_trabajador.php?b="+idtipoeqp);
 ////////////////////////////////////////////////////////////
/* url="buscar_datos_trabajador.php?b=" + idtipoeqp; 
...
//    CargarCombo($("#cbogrupo"),"cargar_combo_array.php?combo=grupo&v=");
}
//(*--------------------------------------------*)
...
<!--                                       <input  name='' id='grupodb' type='text' value=''/>   -->
...
<!--   					  <thead>  -->
						...
						<td colspan="2">
							...
							<tr>
							    <td width="20%"><label>Grupo: </label></td>
...
-->
  					    ...
  					    <tr>
                	                        <td><label>Horas extras: &nbsp;&nbsp;</label>
                        	                <input type="checkbox" class="custom-control-input" id="chksobretiempo" onclick="Activarte();"></td>
						<td>
						    <div id="te"  style="display:none;">
							<table width="100%" border="0">
						                 <td align="right"><label>Ent. Real 1:&nbsp;&nbsp;</label></td>
        	                				 <td><INPUT type="time" maxlength="8" size="8" id="txthoraini1" name="txthoraini1"  value="<?php echo $fecha_a ; ?>" width="6" class="form-control"/><td>
                	        				 <td align="right"><label>Sal. Real 1:&nbsp;&nbsp;</label></td>
	                        				 <td><INPUT type="time" maxlength="8" size="8" id="txthorafin1" name="txthorafin1"  value="<?php echo $fecha_a ; ?>" width="6" class="form-control"/></td>
							</table>
 						   </div> 
						</td>
                  			   </tr>

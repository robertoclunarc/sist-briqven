                                            ...
                                            <table width="50%" class="table table-striped" >
                                                <tr>
                                                    ...
                                                    <th colspan="3" width="80%">
                                                        <select name="cbotrabajador" onchange="consultar(); historico_permisos(); historico_ausencias(); historico_reposos(); historico_medidas_disciplinarias();" id="cbotrabajador" data-width="100%" data-size="5"class="selectpicker" data-live-search="true">

...
function consultar(){
  ...
  //document.getElementById("hddoper").value="consulta_trabajadores_domicilio_online.php";
    $.ajax({
          type: "POST",
          url: "consulta_trabajadores_domicilio_online.php",
...
var dir="consulta_trabajadores_domicilio_online.php";    
    var namexls="Trabajadores_Activos_Domicilio.xls";
    var inpt = '<table><thead><tr><th>'+'listado de Trabajadores activos con su poblaci&oacute;n '+'</th></tr></thead></table>';
...
<header id="titulo">      
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Datos generales trabajadores</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->

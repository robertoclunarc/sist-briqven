...
if (isset($_SESSION['cedula_session_const']) && isset($_SESSION['nivel_const'])){
	...
	$cambiarEsperanza  = isset($_POST["cambiarEsperanza"])?$_POST["cambiarEsperanza"]:"NULL";

	/*if (isset($_POST["cambiarEsperanza"]))
	    print ($_POST["cambiarEsperanza"]);
	else
	    print_r($_POST);    
  */
	...
	if ($tipomovimiento==4){	
		...
		$stmt->execute();
		//$stmt->bindParam(7, "18665365", PDO::PARAM_INT,10);   //CEDULA DE NELKRIS      
...
*/
    if (isset($_POST["cambiarEsperanza"])){
    	 //print "PASO2";
     	 cambiar_turno($sustituto, $motivo, $finicio, $ffin , $causa, $SH, $SH_anterior);
    }
	   ...
	   //SE ENVIA CORREO NOTIFICANDO EL CAMBIO    
		      ...
		      <table border='1'>
		        <tr>
		           ...
		           <td colspan='2'><b>".$nombre_sustituto."</b></td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		           <td colspan='2'>sustituye a: </td>
		           <td colspan='2'><b>".$nombre_sustituido."</b></td>
		        </tr>
		        <tr>
		           <td colspan='2'>C&eacute;dula de indentidad </td>
		           <td colspan='2'>".trim($sustituido)."</td>
		        </tr>
		        <tr>
            ...
            if ($SH_anterior!=$SH){
                $cuerpo .= "
            <tr>
		           <td colspan='2'>Pasando de cuadrilla: </td>
		           <td colspan='2'><b>".$SH_anterior."</b></td>
		        </tr>
            <tr>
		           <td colspan='2'>A la cuadrilla: </td>
		           <td colspan='2'><b>".$SH."</b></td>
		        </tr>	 
		        	"; 
            }
		        ...
		        <tr>   
		           ...
		           <td colspan='2'> Control de Asistencia - Movimiento Temporales.</td>
		        </tr></table>";
...
/*******************************************************************/
//function cambiar_turno($sustituto, $nombre_sustituto, $sustituido,  $nombre_sustituido, $motivo, $finicio, $ffin , $puesto ,$desc_puesto, $causa, $SH, $SH_anterior){

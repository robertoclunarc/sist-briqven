...
*/
   ...
   */   
      ...
      $st2="";
      $cod2="";
      $horas_st = calcular_horas_extras2($fecha, $Inicio_ST1, $Fin_St1, $entEsp1, $salEsp1, $entrada2, $salida2);
      ...
      elseif ($motivo_ST=='')
        ...
        if (($inpt=='1') || ($inpt=='2')){
            ...
            ENVIAR_CORREO($cuerpo,$asunto,"",$_SESSION['user_session_const'], "","matzem@briqven.com.ve","informatico12@gmail.com");

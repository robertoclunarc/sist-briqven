...
$qry="SELECT cedula, VW_kardex_temporal.NOMBRES, FECHA, CONCEPTO, DESC_COD_HORA, TIEMPO, REFERENCIA_04, VW_kardex_temporal.DIRECCION, VW_kardex_temporal.GERGRAL, VW_kardex_temporal.GERENCIA, VW_kardex_temporal.SUPTCIA, REFERENCIA_01, REFERENCIA_03, CAUSA_SUSTITUCION, SUSTITUIDO 
FROM matesisitt.dbo.VW_kardex_temporal 
INNER JOIN ADAM_DATOS_PERSONALES on VW_kardex_temporal.cedula=ADAM_DATOS_PERSONALES.trabajador where fecha BETWEEN '".$finicio."' AND '".$ffin."'"; // ORDER BY cedula,fecha";
/*
$qry="SELECT
       ...
       //$contar=1;        
        if($contar == 0){
            ...
            <tr>
                ...
                <th width="25%" class="info">DESCRIPCION DEL CONCEPTO</th>

...
//#2		if ($sms=="OK"){
            ...
            if (pg_affected_rows($result)==0){
                ...
                $asunto0="Autorizacion de ".$stdlt;
                $cuerpo0="Saludos, Se aprobo el siguiente registro de ".$stdlt."
                <table border = '1'>
                <tr>
                    <td>Cedula</td>
                    <td>".trim($array[0])."</td>
                ...
                //print $link.','.$array[0].','.$array[2].','.$SP.'<br>';
                $responsable_carga_registro_stdlt= responsable_carga_registro_stdlt($link,$array[0],$array[2],$SP); 
        ...
        if ($contador>0){
            ENVIAR_CORREO($cuerpo,$asunto,"",$_SESSION['user_session_const'], "AUTORIZAR STDLT","");
            ...
            //ENVIAR_CORREO($cuerpo,$asunto,"",$_SESSION['user_session_const'], "","informatico12@gmail.com","matvxl@briqven.com.ve");
        }    
//#2	}
        echo "1";

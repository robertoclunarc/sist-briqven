...
function consultar(){
    ...
    $.ajax({
          type: "POST",
          url: "imprimir_planilla_stdlt_online.php",
...
function exportar_excel_cuadro(){
    ...
    if ($("#cbotrabajador").val()!="NULL")
      ...
      var nombre_archivo="";
    var namexls="Planilla_Solicitud__de_STDLT_"+nombre_archivo+"_desde"+desde+"al"+hasta+".xls";
    var inpt = '<table><thead><tr><th>'+'Horas extras y dia libre trabajados. '+'</th><th>'+'Fecha: '+desde+' al '+hasta+'</th></tr></thead></table>';

       $.ajax({
              type: "POST",
              url: "planilla_mensual_stdlt2.php",
              data: $("#formulario").serialize(),
              dataType: "html",
              success: function(data){
                    $("#capa1").empty();
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Planilla de ST y DLT</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Imprimir Planilla de Horas extras y DLT 
                        </div>
                                    ...
                                    <form role="form" id="formulario" method='post'> 
                                      ...
                                      <table width="90%" border="0">    
                                        <tr>
                                          ...
                                          <td rowspan="5"><a onclick="exportar_excel_listado()" title="Exportar Excel" href='#'><img src='images/expor_excel1.png' WIDTH='30' HEIGHT='30'></a> </td>

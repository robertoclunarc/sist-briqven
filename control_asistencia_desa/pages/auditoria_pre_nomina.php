...
<header id="titulo">      
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">Auditoria Pre N&oacute;mina</h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Seleccione el rango de fecha a auditar
                        </div>
...
<table width="90%">    
    <tr>
     ...
     <tr> 
       ...
       <td> &nbsp;</td>
       <td> <select name="tipoauditoria" id="tipoauditoria" class="form-control" >
             <option value="">-</option>
             <option value="1">M&aacute;s de 3 descanso por semana</option>
             <option value="2">Trabajadores disfrutando vacaciones con esperanza diferente a VV:VV</option>
             <option value="3">Solapamiento de permisos</option>
             <!--<option value="4">C&oacute;digo de error</option>-->
             <option value="5">C&oacute;digo error 12</option>
             <option value="6">Fichada NULL</option>
             <option value="7">Entradas reales diferentes a entradas esperadas</option>
             <option value="8">Trabajadores con CodError=9 y esperanza de trabajo</option>
             <option value="9">De vacaciones con CodError!=65</option>
             <option value="10">Hora presencias !=8 con c&oacute;digo de ausencia de pago</option>
             <option value="11">En comision de servicio con Esperanza2 = FF:FF</option>
             <option value="12">Posible Sobre Tiempo</option>
             <option value="13">Total de Ausencias</option>
             <option value="14">Resumen de Ausencias</option>
             <option value="15">Detalle de Ausencias</option>
             <option value="16">Trabajadores con fichada real en dia feriado </option>
            </select>
      </td>

...
//    $query="SELECT * FROM registro_diario where trabajador >'0'  ".$complemento." ORDER BY fecha DESC";
//print $query;    
...
//          $tabla.='<th>Permiso</th>';
	  ...
	  while ($reg = ejecutar_fetch_array($result)) {
                  ...
                  $tabla.='<td><input type="checkbox" class="form-control" id="autorizar[]" value=""></td>';
...
*/
                  ...
                  $tabla.='<td align="center"><input type="hidden" class="form-control" id="entrada_te[]" value="'.$reg['entrada_te'].'">'.$reg['entrada_te'].'</td>';
                  $tabla.='<td align="center"><input type="hidden" class="form-control" id="salida_te[]" value="'.$reg['salida_te'].'">'.$reg['salida_te'].'</td>';
...
//		  else
                      $tabla.='<td><input type="hidden" class="form-control" id="observacion_te[]" value="'.$reg['observacion_te'].'">'.$reg['observacion_te'].'</td>';
//                  $tabla.='</tr>';
                  $i++;

...
<head>  
    ...
    <title>Solicitud Permisos</title>
...
{
  elemento = document.getElementById("deportivo");
  var tipo = parseInt($("#cbotipopermiso").val());
  if (tipo=='1'){
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">                
                <a class="navbar-brand" href="index.php">solicitud de Permisos</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Solicitud de Permisos</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<table width="90%" border="0">    
    ...
    <tr>
       <td width="5%"><label>Tipo de Permisos:</label></td>
       <td width="15%" colspan="2"><div class="col-xs-10">
            <select onchange="tipo_permiso();" name="cbotipopermiso" id="cbotipopermiso" data-width="80%" data-size="5" class="selectpicker" data-live-search="true">
               <option selected value="NULL">Seleccione el tipo de Permiso</option>
               <option selected value="1">Deportivo</option>
               <option selected value="2">No Deportivo</option>
            </select>
          </div>
      </td>     
      <td width="1%">
      ...
      <td width="6%"><label>Trabajador:<!-- C.Costo: --></label></td>
    ...
    <tr>
       ...
       <td colspan="2"><div class="col-xs-10"><INPUT type="text" readonly id="txtpuesto" maxlength="50" name="txtpuesto" value="" width="100%" class="form-control"/></div></div>
       </td>     
       <td> &nbsp;</td>
       <td><label>Trabajador Sup.:</td>
   ...
   <!-- <tr>
    ...
    <div id="deportivo" style="display: block;"> 
      <tr>
         <td><label>Centro Deportivo:</label></td>
         <td colspan="2"><div class="col-xs-12"><INPUT type="text" id="txtcentrodeportivo" maxlength="200" name="txtcentrodeportivo" value=""  width="80%" class="form-control"/></div>
         </td>     
         <td> &nbsp;</td>
         <td><label>Disciplina:</td>
         <td><div class="col-xs-12"><INPUT type="text" id="txtdisciplina" maxlength="200" name="txtdisciplina" value=""  width="80%" class="form-control"/></div></div>
         </td>
      </tr>
    </div>
    <tr>
    ...
    <tr>
       <td><label>Descripci&oacute;n Permiso:</label></td>
       <td colspan="5"><div class="col-xs-12"><INPUT type="text" id="txtcondicion" maxlength="200" name="txtcondicion" value=""  width="80%" class="form-control"/></div></td> 
    </tr>
...
<!--
    <tr>
       ...
       <td colspan="5"><div class="col-xs-12"><INPUT type="text" readonly id="txtdocrequerido" maxlength="200" name="txtdocrequerido" value=""  width="80%" class="form-control"/></div></td>
...
<p>&nbsp;</p>  
      <table class="" width="90%" id="tblGuardar" align="center" border='0'>  
        <tr>
          <td width="30%">&nbsp;</td>
          <td width="40%" align="center"><INPUT id="cmdGuardar" type="button" value="Imprimir Planilla"  class="btn btn-success" ondblclick="Guardar();"/></td>
          <td width="30%">&nbsp;</td>
        </tr>
      </table>

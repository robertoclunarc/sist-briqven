...
function exportar_excel(){    
    ...
    var namexls="Ausencias_"+desde+"al"+hasta+".xls";
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">                
                <a class="navbar-brand" href="index.php">Ausencia 01</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Reporte Ausencia</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Consulta de Ausencias en la Hoja de Tiempo
                        </div>
...
<table width="90%">    
    <tr>
      ...
      <td> &nbsp;</td>
       ...
       <td> &nbsp;</td>
       <td><label>Fichadas:</label></td>
       <td> &nbsp;</td>
       <td><label>Sist. Horario:</label></td>
       <td> &nbsp;</td>
       <td> &nbsp;</td>
    </tr>    
     ...
     <tr> 
      ...
      <td> &nbsp;</td>
      <td> <select class="selectpicker" name="cbofichada" id="cbofichada" class="form-control" >
             <option selected value="NULL">Todas</option>
             <option value="(entrada_real1 is null or salida_real1 is null)">Impar</option>         
             <option value="(entrada_real1 is null and salida_real1 is null)">Ninguna</option>
            </select>
      </td>
      <td> &nbsp;</td>
      <td> <select class="selectpicker" name="cbosh" id="cbosh" class="form-control" >
             <option selected value="NULL">Todas</option>
    ...
    <tr>
      <td><label>Vacacion</label>
          <div class="checkbox">
              <label>
                  <input name="chkausencia[]" type="checkbox" value="'VV:VV'">
              </label>
          </div></td>
      <td> &nbsp;</td>
       <td><label>Libre</label>
          <div class="checkbox">
              <label>
                  <input name="chkausencia[]" type="checkbox" value="'LL:LL'">
              </label>
          </div></td>
       <td> &nbsp;</td>
       <td><label>Reposo</label>
          <div class="checkbox">
              <label>
                  <input name="chkausencia[]" type="checkbox" value="'RR:RR'">
              </label>
          </div></td>
       <td> &nbsp;</td>
       <td><label>Permiso</label>
          <div class="checkbox">
              <label>
                  <input name="chkausencia[]" type="checkbox" value="'PP:PP'">
              </label>
          </div></td>
       <td> &nbsp;</td>
       <td><label>Comision</label>
          <div class="checkbox">
              <label>
                  <input name="chkausencia[]" type="checkbox" value="'CS:CS'">
              </label>
          </div></td>
       <td> &nbsp;</td>
       <td><label>Suspencion</label>
          <div class="checkbox">
              <label>
                  <input name="chkausencia[]" type="checkbox" value="'SD:SD'">
              </label>
          </div></td>
       <td> &nbsp;</td>
       <td><label>Feriado</label>
          <div class="checkbox">
              <label>
                  <input name="chkausencia[]" type="checkbox" value="'FF:FF'">
              </label>
          </div></td>
    </tr>    
</table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Ficha</h5>

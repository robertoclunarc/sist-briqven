            ...
            <tfoot>
              ...
              while($row=pg_fetch_array($res)){
                    ...
                    if ($entrada=='' && $enviar=='NO'){
                      if ($esperanza=='07:00' || $esperanza=='15:00' || $esperanza=='23:00' || $esperanza=='FF:FF' || $esperanza=='LL:LL'){
                        if ($esperanza=='07:00' || $esperanza=='15:00' || $esperanza=='23:00'){
                          $op="<td class='bg-warning'>";//si tiene esperanza de trabaja pinta de amarillo
                        }else{
                          $op="<td class='bg-danger'>";//si tiene esperanza de trabaja pinta de rojo
                        }
                        ...
                        $op="<td class='bg-info'>";// si esta VV,PP,RR,CS pinta de azul

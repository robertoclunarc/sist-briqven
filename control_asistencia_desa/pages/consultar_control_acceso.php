...
<head>
    ...
    <title>Ingreso Control Acceso</title>
...
function consultar(){
    $.ajax({
          type: "POST",
          url: "./consultar_control_acceso_online.php",
...
function exportar_excel(){
    ...
    var namexls="Fichadas_Control_acceso_"+desde+"al"+hasta+".xls";
...
//(*--------------------------------------------*)
function exportar_fichada(cedula, fecha, ent, sal, sp){

       $.ajax({
              type: "GET",
              url: "envia_sitt_sp.php?cedula="+cedula+"&fecha="+fecha+"&entrada1="+ent+"&salida1="+sal+"&SP="+sp+"&coderror=70",
              //data: $("#formulario").serialize(),
              dataType: "html",
              beforeSend: function(){
                //imagen de carga
                ...
                $("#div_"+cedula+"_"+fecha).append("<p align='center'><img src='images/loading.gif' WIDTH='15' HEIGHT='15' /></p>");
              },
              error: function(){
                alert("error petición ajax");
              },
              success: function(data){                       
                $("#div_"+cedula+"_"+fecha).empty();
                $("#capa2").append('<div class="alert alert-warning">'+data+' </div>');
                setTimeout(() => {                    
                    $("#capa2").empty(); 
                  }, 15000);
...
<header id="titulo">      
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Reporte de Asistencia (Control Acceso)</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->

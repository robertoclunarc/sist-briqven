...
function consultar(){
  ...
  //var url = "buscar_sustituciones.php";
...
function fichar(){
  ...
  $.ajax({
          type: "POST",
          url: "cargar_movimiento_directo_bd_sitt.php",
          data: $("#formulario").serialize(),
          dataType: "html",
          beforeSend: function(){
                //imagen de carga
                            ...
                            <table width="50%" class="table table-striped" border="0">                 
                              <tr>
                                ...
                                <th width="100%" colspan="3">
                                    <textarea name="txtmotivo" id="txtmotivo" placeholder="Motivo del movimiento" rows="2" cols="60%"></textarea>
                                </th>
                              </tr>                  
    					              </table>
                          </div>  

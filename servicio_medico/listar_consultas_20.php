...
<html>
    <head>
        <title>Sist. Listado de Consultas</title>
        <meta charset="utf-8">
        <!--    ESTILO GENERAL   -->
...
<?php 
/*
echo "<tr><td>" . "<a target='_blank' href='planilla_consulta.php?uid=".$fila["uid"]."'>" . $fila["uid"] . "</a>" . "</td><td>" .  $fila["ci"] . "</td><td>" . $fila["nombre_completo"] .  "</td><td>" . $fila["motivo"] . "</td><td>";
*/
}else{

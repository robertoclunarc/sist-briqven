...
if ($("#cboDiagnostico").val()=="null")
  {
    alert("Seleccione el Tipo Diagnostico");
    //document.getElementById("cmdGuardar").disabled = false;
    $("#cboDiagnostico").focus();
    return;;   
  }  
...
if ($("#txtSintomas").val()=="")
  ...
  if (($("#cboMotivos").val()==1) && ($("#cboPatologias2").val()=="null"))
  {
    alert("Seleccione La Patología");
    //document.getElementById("cmdGuardar").disabled = false;
    $("#cboTipoConsulta").focus();
    return;  
  }

  if ($("#cboPatologias2").val()=="")
  {
    seleccionar_diag(1);
  }


  if ($("#cboTipoConsulta").val()=="null")
  {
...
function seleccionar_diag(id){
  alert(id);
  document.getElementById("cboPatologias2").value = id;
}
...
$(document).ready(function(){
  ...
  CargarCombo($("#cboMedico"),"cargar_combo_db.php?tabla=v_medico_con_usuario&campo1=uid&campo2=nombre&selected=0&orderby=nombre desc&where=activo and login='"+$("#txtlogin").val()+"'");

    if ($("#txtnivel").val()==1)
      {
        CargarCombo($("#cboParaMedico"),"cargar_combo_db.php?tabla=tbl_paramedicos&campo1=uid&campo2=nombre&selected=0&firsttext=[Elija Enfermero(a)]&orderby=nombre&where=activo");
 ...
 CargarCombo($("#cboMotivos"),"cargar_combo_db.php?tabla=tbl_motivos&campo1=uid&where=activo=true&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Elija un motivo]");
  ...
  CargarCombo($("#cboTipoConsulta"), "cargar_combo_db.php?tabla=tbl_tipo_consulta&campo1=uid&campo2=descripcion&selected=0&orderby=uid&firsttext=[Seleccione Tipo de Consulta]");

  //CargarCombo($("#cboPatologias2"), "cargar_combo_db.php?tabla=tbl_patologias&campo1=uid&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Seleccione Tipo de Consulta]");

CargarCombo($("#cboDiagnostico"),"cargar_combo_db.php?tabla=tbl_diagnostico&campo1=uid&campo2=descripcion&selected=0&firsttext=[Elija el tipo de Diagnostico]&orderby=descripcion");
...
function cambio_diagnostico(){
  var tipo_diagnostico = $("#cboDiagnostico").val();
  /*console.log($("#txtnivel").val());
    if ($("#txtnivel").val()==1)
      {
        //CargarCombo($("#cboParaMedico"),"cargar_combo_db.php?tabla=tbl_paramedicos&campo1=uid&campo2=nombre&selected=0&firsttext=[Elija Enfermero(a)]&orderby=nombre&where=activo");
        //CargarCombo($("#cboMotivos"),"cargar_combo_db.php?tabla=tbl_motivos&campo1=uid&where=activo=true&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Elija un motivo]&where=activo and fkdiagnostico="+tipo_diagnostico);
      }
    else  
    {   
      //CargarCombo($("#cboParaMedico"),"cargar_combo_db.php?tabla=tbl_paramedicos&campo1=uid&campo2=nombre&selected=0&orderby=nombre&where=activo and login='"+$("#txtlogin").val()+"'");
      //CargarCombo($("#cboMotivos"),"cargar_combo_db.php?tabla=v_motivos_no_examen&campo1=uid&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Elija un motivo]&where=activo and fkdiagnostico="+tipo_diagnostico);
    }*/  
CargarCombo($("#cboMotivos"),"cargar_combo_db.php?tabla=tbl_motivos&campo1=uid&where=activo=true&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Elija un motivo]&where=activo and fkdiagnostico="+tipo_diagnostico);    
  //CargarCombo($("#cboMotivos"),"cargar_combo_db.php?tabla=v_motivos_no_examen&campo1=uid&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Elija un motivo]&where=activo and fkdiagnostico="+tipo_diagnostico);
}
...
function cambio_motivo(){
  ...
  if (mot==1){
    ...
    if ($("#txtnivel").val()==1){
        CargarCombo($("#cboPatologias2"), "cargar_combo_db.php?tabla=tbl_patologias&campo1=uid&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Seleccione Tipo de Consulta]&where=estatus and view=1");
    }else{
        CargarCombo($("#cboPatologias2"), "cargar_combo_db.php?tabla=tbl_patologias&campo1=uid&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Seleccione Tipo de Consulta]&where=estatus and view=2");
    }
    document.getElementById('cboPatologias2').disabled=false;
  }else{
    autorizacion.checked = false;
    CargarCombo($("#cboPatologias2"), "cargar_combo_db.php?tabla=tbl_patologias&campo1=uid&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Seleccione Tipo de Consulta]&where=activo and fkdiagnostico=0");
    document.getElementById('cboPatologias2').disabled=true;
...
function cambio_motivo(){
  ...
  if (mot==1){
    autorizacion.checked = true;
    CargarCombo($("#cboPatologias2"), "cargar_combo_db.php?tabla=tbl_patologias&campo1=uid&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Seleccione Tipo de Consulta]");
    //$("#cboPatologias2").removeAttr("readonly");
    document.getElementById('cboPatologias2').disabled=false;
  }else{
    autorizacion.checked = false;
    CargarCombo($("#cboPatologias2"), "cargar_combo_db.php?tabla=tbl_patologias&campo1=uid&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Seleccione Tipo de Consulta]&where=activo and fkdiagnostico=0");
    // document.getElementById("cboPatologias2").readonly; 
    //$("#cboPatologias2").attr("readonly","readonly");
    document.getElementById('cboPatologias2').disabled=true;
 ...
 */
    ...
    //document.getElementById('txtHora').textContent = hours+':'+minutes+':'+seconds;

    //setInterval(udateTime, 1000);
    //setTimeout("udateTime()",1000);
    horaImprimible = hours + " : " + minutes + " : " + seconds + "  " +  meridiano;

    document.formulario.txtHora.value = horaImprimible;
...
<form id="formulario" name="formulario" method='post'>
    ...
    <p align="right">
    Fecha:<input size="10" readonly="" name='txtFecha' id='txtFecha' type='text' value='<?php echo(date("Y-m-d")); ?>'/>&nbsp;&nbsp;Hora:<input size="10" readonly="" name='txtHora' id='txtHora' type='text' value='<?php echo(date("h:i:s")); ?>'>&nbsp;Turno:<input size="10"  maxlength="1" name='txtTurno' id='txtTurno' type='text' value='<?php echo $turno; ?>'/></p>
    <article>    
...
<table width="100%">      
    ...
    <tr>
      ...
      <td><select class="form-control" onchange="cambio_diagnostico();" name="cboDiagnostico" id="cboDiagnostico" ></select></td>
      <td> &nbsp;</td>
...
<table width="100%">
  ...
  <tr>
    ...
    <td width="100%"><input maxlength="100" name="txtSintomas" id="txtSintomas" rows="4"  width="100%" class="form-control"></td> 
  </tr>
  <TR>
  ...
  <td width="100%"><?php if ($_SESSION['nivel']==1) {  ?>
  	...
  	<input name="txtObservaciones" id="txtObservaciones" rows="4"  width="100%" maxlength="250" class="form-control"></td> 
  	<?php }  ?></td>
  </tr>
  <TR>
    <td width="100%">&nbsp;</td>
    ...
    <td width="100%">
        <table width="100%">
          <tr>
            ...
            <td width="40%"><br><LABEL>Diagnostico</LABEL></td>
          </tr>  
          <tr>
            <td colspan="4"><INPUT type="text"  maxlength="1000" id="txtDiagnostico" name="txtDiagnostico" width="100%" class="form-control"/></td>  
          </tr>
          <tr>
              <td><label>Patología:</label></td>  
              <td width="20%"><br><LABEL>Tipo Consulta</LABEL></td>
              <td width="40%"><br><LABEL>Tipo de Afecciones por Sistema</LABEL></td>
          </tr>
          <tr>
              <td><select class="form-control" name="cboPatologias2" id="cboPatologias2" disabled></select></td>
              <td><select class="form-control" name="cboTipoConsulta" id="cboTipoConsulta" ></select></td>

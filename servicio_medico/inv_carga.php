...
<form id="formulario" method='post'>
    ...
    <p><label>CARGA DE MEDICAMENTOS</label></p>
    <p align="right">
    Fecha:<input size="10" name='txtFecha' id='txtFecha' readonly="" type='text' value='<?php echo(date("d/m/Y")); ?>'/></p>
    <article>    
...
<TR><td width="100%"><LABEL>MEDICAMENTOS QUE SE INGRESAN</LABEL></td></TR>
<tr>
<table>
...
<tr>
 <table class="table-bordered" width="100%" id="tblMedicamentos">
   <tr><td width="10%">Código</td><td width="70%">Descripción</td><td width="10%">Cantidad</td><td width="10%"></td></tr>
 </table>
</tr>
...
<tr><td align="center"><INPUT id="cmdGuardar" type="button"  value="Registrar Carga"  class="form-control" onclick="GuardarConsulta();"/></td></tr>
</table>

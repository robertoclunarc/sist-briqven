...
<title>Cargar Estudio Fisico</title>
...
<form id="formulario" method='post'>
    ...
    <p><label>INGRESAR ESTUDIO FISICO</label></p>   
...
<tr>
	<td width="100%">NRO DE LINEAS A OCUPAR EN FORMATO Y PANTALLA:</td>
</tr>
<tr>
	<td width="100%"><INPUT type="text" id="txlinea" name="txtlinea" maxlength="1" value="1" onKeyPress="return soloNumeros(event)" width="100%" class="form-control"/></td>
</tr>
<tr>
	<td width="100%">&nbsp;</td>
</tr>
...
function GuardarConsulta()
{
        ...
        url = "registrar_examfisico_db.php";
        $.ajax({
           type: "POST",
           url: url,

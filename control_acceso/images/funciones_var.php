...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
function notif_vigilantes($idmov, $tipomov, $stamov, $cc, $nombre, $operacion, $formato){
	require_once('libs/conexion.php');
	$conn=Conectarse();	
...
{
	$sql1 = "SELECT operacion, estatus FROM usuarios_movimientos WHERE fkmovimiento_part=".$idmov;
	$res1 = pg_query($cn,$sql1);	

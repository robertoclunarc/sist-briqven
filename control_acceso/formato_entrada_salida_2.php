<?php
function planilla_entrada_salida_html2 ($idmov){
...
///////////usuario solicitante
$listado2=pg_query($cn,"SELECT * FROM usuarios_movimientos where operacion='SOLICITADO' and fkmovimiento_part=".$idmov);
$reg2 = pg_fetch_array($listado2, null, PGSQL_ASSOC);
/////////////usuario conformante
$listado3=pg_query($cn,"SELECT * FROM usuarios_movimientos where operacion='CONFORMADO' and fkmovimiento_part=".$idmov);
$reg3 = pg_fetch_array($listado3, null, PGSQL_ASSOC);
//////////////////////usuario autorizante
$listado4=pg_query($cn,"SELECT * FROM usuarios_movimientos where operacion='AUTORIZADO' and fkmovimiento_part=".$idmov);
$reg4 = pg_fetch_array($listado4, null, PGSQL_ASSOC);
//////////////////////usuario validador
$listado5=pg_query($cn,"SELECT * FROM usuarios_movimientos where operacion='VALIDADO' and fkmovimiento_part=".$idmov);
...
$html.='<head>';
	...
	$html.='<title>Movimiento E/S</title>';
$html.='</head>';
$html.='<body>';	

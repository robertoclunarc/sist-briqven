...
$cn=  Conectarse();
$listado =  pg_query($cn,"SELECT a.*, round(a.total_pagar::numeric, 2) as totalredondeado  FROM pagos_periodos_trabajadores a  WHERE a.mesp='".$_GET['me']."' and a.anhop='".$_GET['an']."'");
...
header('content-disposition: attachment;filename=ABONOTICKET'.nombremes($_GET['me']).'20'.$_GET['an'].'.xls');
?>
<html>
<head>

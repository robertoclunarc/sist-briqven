...
if ($("#tn_real").val()=="")
  {
    alert("Ingrese la cantidad de tonelada real del d&iacute;a");
    $("#ci").focus();
    return;
  }
...
function buscarDatosAnt()
{
  ...
  if (linea != "null" && fecha != ''){
      mostrar("ver", "images/loading.gif");  
      url="cargar_datos_anteriores.php?fecha=" + fecha+"&linea="+linea;  
...
<p>&nbsp;</p>    
    ...
    <tr>
      ...
      <th width="12%">Tn. Prog. Acumuladas</th>
        ...
        <tr>
         <td >            
            <input id="tn_real" name="tn_real" type="text" class="form-control" style="z-index: 0;" placeholder="eeeeeeeee.dd" maxlength="12" onkeypress="return validar(event);" onkeyup="calcular()" >
        </td>
       <td > &nbsp;</td>    
       <td >            
            <input id="tn_prog" name="tn_prog" type="text" class="form-control" style="z-index: 0;" placeholder="eeeeeeeee.dd" maxlength="12" onkeypress="return validar(event);" onkeyup="calcular()" > 
        </td> 
        <td > &nbsp;</td>    
       <td >            
    ...
    <tr>
      ...
      <th width="12%">Tn. estimadas al cierre del mes</th> 
       ...
       <td >            
        ...
        <td > &nbsp;</td>    
       <td >            
            <input id="tn_desp_var_mes" name="tn_desp_var_mes" type="text" class="form-control" style="z-index: 0;" placeholder="eeeeeeeee.dd" maxlength="12" onkeypress="return validar(event);" onkeyup="calcular()" >              
        </td>
        <td > &nbsp;</td>    
       <td >            
       ...
       <tr>
        ...
        <td > &nbsp;</td>
        <td >            
            <input id="tn_var_cierre" name="tn_var_cierre" type="text" class="form-control" style="z-index: 0;" placeholder="eeeeeeeee.dd" maxlength="12" onkeypress="return validar(event);" onkeyup="calcular()" >              
        </td>
        <td > &nbsp;</td>
        <td >            
        ...
        <td > &nbsp;</td>
        <td >            
            <input id="tn_desp_var_acum" name="tn_desp_var_acum" type="text" class="form-control" style="z-index: 0;" placeholder="eeeeeeeee.dd" maxlength="12" onkeypress="return validar(event);" onkeyup="calcular()" >              
        </td>
      </tr>
      <tr>
          <td > &nbsp;</td>   

...
//$fecha_inicio	= '2020-08-27'; 		// FECHA A PARTIR PRINCIPIO DE A;O
$fecha_inicio	= date ( 'Y-m-d' ,strtotime ( '-7 day' , strtotime ( $fecha_hoy)));  		// FECHA A PARTIR PRINCIPIO DE A;O
$linea = "BRV1";
$cod_linea = $linea;
$mercado= "V1";   //
$producto= "112";   //
...
//print "<br>".$query0."<br>mes_ant=".$mes_ant."<br>dia_ant=".$dia_ant;
...
//print "<br>".$sql;
   ...
   //$cant_row 		= $stmt->rowCount();	
   $cant_row		= $stmt->fetchColumn();
   $row 		= $stmt->fetch();
...
//print "sql=".$sql."<br>";
//print "<br>filas afectadas=".$cant_row."<br>row=".$row."<br>col=".$col."<br>result =".count($result);
//   if ($cant_row>0){ 
